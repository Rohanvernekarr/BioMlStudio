                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      {[
                        { 
                          ...
                          description: 'Excellent for sequence pattern recognition and local feature extraction',
                          icon: Search,
                          iconColor: 'text-blue-400',
                          bestFor: 'DNA/Protein sequence motifs'
                        },
                        { 
                          id: 'rnn', 
                          name: 'RNN (Recurrent Neural Network)', 
                          description: 'Perfect for sequential data and time-series biological patterns',
                          icon: RotateCcw,
                          iconColor: 'text-green-400',
                          bestFor: 'Sequential biological data'
                        },
                        { 
                          id: 'bilstm', 
                          name: 'BiLSTM (Bidirectional LSTM)', 
                          description: 'Advanced sequence modeling with forward and backward context',
                          icon: ArrowLeftRight,
                          iconColor: 'text-yellow-400',
                          bestFor: 'Complex sequence dependencies'
                        },
                        { 
                          id: 'transformer', 
                          name: 'Transformer (Attention-based)', 
                          description: 'State-of-the-art for biological sequence understanding',
                          icon: Target,
                          iconColor: 'text-red-400',
                          bestFor: 'Long-range dependencies'
                        }
                      ].map((model) => {
